...
void bhv_mips_init(void) {
    ...
    if (randomizer_current_star_is_mips(MIPS_BP_15_STARS)) {
        o->oBhvParams2ndByte = MIPS_BP_15_STARS;
#ifndef VERSION_JP
        o->oMipsForwardVelocity = 40.0f;
#endif
    } else if (randomizer_current_star_is_mips(MIPS_BP_50_STARS)) {
    ...
    else if (save_file_get_total_star_count(gCurrSaveFileNum - 1, COURSE_MIN - 1, COURSE_MAX - 1) >= 15
