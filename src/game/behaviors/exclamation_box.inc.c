...
static s32 exclamation_box_star_index(void) {
    switch (o->oBhvParams2ndByte) {
        case EXCLAMATION_BOX_BP_STAR_ACT_1: return STAR_INDEX_ACT_1;
        case EXCLAMATION_BOX_BP_STAR_ACT_2: return STAR_INDEX_ACT_2;
        case EXCLAMATION_BOX_BP_STAR_ACT_3: return STAR_INDEX_ACT_3;
        case EXCLAMATION_BOX_BP_STAR_ACT_4: return STAR_INDEX_ACT_4;
        case EXCLAMATION_BOX_BP_STAR_ACT_5: return STAR_INDEX_ACT_5;
        case EXCLAMATION_BOX_BP_STAR_ACT_6: return STAR_INDEX_ACT_6;
    }

    return -1;
}

static s32 exclamation_box_hide_inactive_star(void) {
    s32 starIndex = exclamation_box_star_index();

    if (starIndex >= 0 && !randomizer_current_star_matches(gCurrCourseNum, gCurrLevelNum, starIndex)) {
...
void bhv_exclamation_box_loop(void) {
    if (exclamation_box_hide_inactive_star()) {
        return;
    }
