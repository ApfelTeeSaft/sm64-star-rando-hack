...
extern struct SequencePlayer gSequencePlayers[];
...
// The randomizer voice asset registration adds extra sequence, CTL, and TBL
// headers at boot. Vanilla US/JP leaves very little slack in the init pool, so
// reserve a little more from the same audio heap before any session pools are
// split. This does not load the voice samples into RAM.
#define AUDIO_INIT_POOL_SIZE 0x2900
#endif
