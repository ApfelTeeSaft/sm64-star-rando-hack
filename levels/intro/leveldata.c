...
ALIGNED8 static const Texture intro_seg7_texture_rando_logo[] = {
#include "levels/intro/rando_logo.rgba16.inc.c"
};

static const Vtx intro_seg7_vertex_rando_logo[] = {
    {{{  -720,   -720,      0}, 0, {     0,    992}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   720,   -720,      0}, 0, {   992,    992}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   720,    720,      0}, 0, {   992,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{  -720,    720,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};

static const Gfx intro_seg7_dl_rando_logo_plane[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING | G_CULL_BACK),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(intro_seg7_texture_rando_logo, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0,
                         G_TX_CLAMP, G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(intro_seg7_vertex_rando_logo, 4, 0),
...
const Gfx intro_seg7_dl_logo[] = {
    gsSPDisplayList(intro_seg7_dl_rando_logo_plane),
    gsSPEndDisplayList(),
};
